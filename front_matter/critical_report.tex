...
\title{Stabat mater}
\subtitle{(A-Wn SA.67.H.5)}
\scoring{S, A, T, B, b, org}
\maketitle
...
This edition bases upon a copy in the Austrian National Library. The digital version of the manuscript is available at \url{http://data.onb.ac.at/rec/AC14297619} (siglum SA.67.H.5; no RISM entry).
...
\begin{longtable}{lll L{10cm}}
  ...
  \midrule \endhead
  – & –  & –   & Red annotations in the Ms, which presumably were added \newline by later hand, have been ignored for this edition. \\
  1 & 19  & T   & 4th quarter in Ms: d′4 \\
  4 & 3   & org & 1st quarter in Ms: Bes8–A16–G16 \\
    & 13  & T   & 2nd half of bar in Ms: 2 x r16–d′16–es′16–d′16 \\
  6 & 2   & org & last eighth in Ms: f8 \\
  7 & 54  & S   & 5th quarter in Ms: d″4 \\
  8 & 26  & A   & 6th eighth in Ms: g′16–as′16 \\
  9 & 4   & T   & 1st quarter in Ms: c′4 \\
    & 48f & org & notes in violin clef added by editor \\
  \bottomrule
\end{longtable}


This edition has been compiled and checked with utmost diligence. Nevertheless, errors and mistakes cannot be totally excluded. Please report any errors and mistakes to \url{wolfgang@esser-skala.at} or create an issue or pull request on the edition’s GitHub page \url{https://github.com/skafdasschaf/tuma-stabat-mater}. Your help will be greatly appreciated.
